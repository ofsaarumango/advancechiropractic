    ...
    <div className="w-full">
      ...
      >
        ...
        <div className="relative z-10 max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop w-full">
          <div className="max-w-2xl">
            <h1 className="font-headline-xl text-headline-lg-mobile md:text-headline-xl font-bold text-on-primary mb-6">Therapies</h1>
            <p className="font-body-lg text-body-lg text-on-primary/90">Have a glance at the therapies we provide.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-margin-mobile md:px-margin-desktop max-w-max-width mx-auto">
        <div className="text-center mb-16">
          <h2 className="font-headline-lg text-[32px] font-bold text-deep-blue-primary mb-4">Featured Treatments</h2>
          <p className="font-body-md text-body-md text-on-surface-variant max-w-2xl mx-auto">
            Discover our specialized treatment programs designed to accelerate recovery and restore optimal function.
          </p>
        </div>
          ...
          {featuredTreatments.map((treatment, index) => (
            <article key={index} className="bg-surface-container-lowest border border-outline-variant rounded-xl overflow-hidden group hover:shadow-[0_8px_30px_rgb(26,54,93,0.08)] transition-all duration-300 flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <Link href="/contact" className="inline-flex items-center gap-2 font-label-md text-label-md text-healthcare-teal hover:text-deep-blue-primary transition-colors mt-auto">
      ...
      <section className="py-20 bg-surface px-margin-mobile md:px-margin-desktop">
        <div className="max-w-max-width mx-auto">
          <div className="mb-12 text-center md:text-left">
            <h2 className="font-headline-lg text-[32px] font-bold text-deep-blue-primary mb-4">Many More...</h2>
            <p className="font-body-md text-body-md text-on-surface-variant">A wide array of evidence-based treatments tailored to your specific recovery needs.</p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {additionalTherapies.map((item, index) => (
